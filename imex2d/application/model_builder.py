...
class ReservoirModelBuilder:
    ...
    def build(self,
              ...
              gas_capillary: Optional[CapillaryParameters] = None,
              initial: Optional[InitialConditions] = None,
              pvt_table: Optional[PVTTable] = None,
              pvt_oil_branches=None,
              scal_tables=None,
              gas_scal_tables=None,
        ...
        return ReservoirModel(
            ...
            gas_capillary_parameters=gas_capillary or CapillaryParameters(),
            pvt_table=pvt_table,
            pvt_oil_branches=pvt_oil_branches,
            scal_tables=scal_tables,
            gas_scal_tables=gas_scal_tables,
            units=units,
